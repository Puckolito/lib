...
local Options, MiscOptions do
    ...
    MiscOptions = {
        ...
        ["Boxes"] = false;
        ["BoxType"] = "Corner";
        ["Box Gradient 1"] = { Color = rgb(170, 130, 255), Transparency = 0.9 };
        ["Box Gradient 2"] = { Color = rgb(255, 0, 0), Transparency = 0.4 };
        ["Box Gradient Rotation"] = 90;
        ["Box Fill"] = false;
        ["Box Fill 1"] = { Color = rgb(170, 130, 255), Transparency = 0.9 };
        ["Box Fill 2"] = { Color = rgb(170, 130, 255), Transparency = 0.9 };
        ["Box Fill Rotation"] = 0;
...
local Library do
    ...
    local Instances = { } do
        ...
        Instances.AddToTheme = function(self, Properties)
            if not self.Instance or not Library.AddToTheme then
                return
            end
    ...
    local CustomFont = { } do
        ...
        CustomFont:New("Inter", 200, "Regular", {
            ...
            Library.UseCustomCursor = false
    Library.SetCustomCursor = function(self, Bool)
        self.UseCustomCursor = Bool
        if not Bool then
        ...
        if self.WindowInstance and self.WindowInstance.SetOpen then
            self.WindowInstance:SetOpen(not self.WindowInstance.IsOpen)
        elseif self.CurrentWindow and self.CurrentWindow.SetOpen then
    ...
    Library.Round = function(self, Number, Float)
        ...
        local Multiplier = (Float and Float ~= 0) and (1 / Float) or 1
    ...
    Library.IsMouseOverFrame = function(self, Frame, XOffset, YOffset)
        ...
        elseif type(Frame) == "table" and Frame.Instance then
    ...
    local Components = { } do
        ...
        Components.Dropdown = function(Data)
            ...
            local Items = { } do
                ...
                Items["UICorner"] = Instances:Create("UICorner", {
            ...
            function Dropdown:AddOption(Option)
                ...
                function OptionData:Toggle(Status)
                    if Status == "Active" then
                        ...
                        OptionData.Text:Tween(nil, {TextTransparency = 0, Position = UDim2New(0, 10, 0.5, 0)})
                    elseif Status == "Inactive" then
                        OptionData.Button:Tween(nil, {BackgroundTransparency = 1})
                        OptionData.Text:Tween(nil, {TextTransparency = 0.5, Position = UDim2New(0, 10, 0.5, 0)})
                    end
                end

                function OptionData:Set()
                    if not Data.Multi and OptionData.Selected then return end
            ...
            function Dropdown:SetOpen(Bool)
                ...
                Items["Holder"].Instance.Parent = Bool and Library.Holder.Instance or Library.UnusedHolder.Instance
                ...
                if Bool then
                    ...
                    RenderStepped = RunService.RenderStepped:Connect(function()
                        Items["Holder"].Instance.Position = UDim2New(0, Items["RealDropdown"].Instance.AbsolutePosition.X, 0, Items["RealDropdown"].Instance.AbsolutePosition.Y + 30)
                        local _optCount = 0
                        for _ in pairs(Dropdown.Options) do _optCount = _optCount + 1 end
                        if _optCount == 0 then _optCount = 1 end
                        local _maxLimit = (Data.MaxSize and Data.MaxSize <= 15) and Data.MaxSize or 6
                        local _actualCount = math.min(_optCount, _maxLimit)
                        local _calculatedHeight = _actualCount * 25 + 8
                        Items["Holder"].Instance.Size = UDim2New(0, Items["RealDropdown"].Instance.AbsoluteSize.X, 0, _calculatedHeight)
                    end)
                    ...
                    local _ddKey = Data.Flag or Data.Name or "Dropdown"
                    Library.OpenFrames[_ddKey] = Dropdown
                else
                    local _ddKey = Data.Flag or Data.Name or "Dropdown"
                    if Library.OpenFrames[_ddKey] then
                        Library.OpenFrames[_ddKey] = nil
                    end
                ...
                local Descendants = Items["Holder"].Instance:GetDescendants()
                TableInsert(Descendants, Items["Holder"].Instance)
                ...
                for Index, Value in Descendants do
                    ...
                    Value.ZIndex = Bool and 50 or (Value.ZIndex > 50 and Value.ZIndex - 40 or Value.ZIndex)
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    if Library:IsMouseOverFrame(Items["Holder"]) then
                        return
                    end
            ...
            if Data.Default then
                local _default = Data.Default
                if type(_default) == "number" and Data.Items and Data.Items[_default] then
                    _default = Data.Items[_default]
                end
                Dropdown:Set(_default)
            end
        ...
        Components.Colorpicker = function(Data)
            ...
            setmetatable(Colorpicker, {
                __index = function(t, k)
                    if k == "Value" then return rawget(t, "Color") end
                    return rawget(t, k)
                end
            })
            ...
            local Items = { } do
                ...
                local DropdownItems = { } do
                    ...
                    DropdownItems["OpenIcon"] = Instances:Create("ImageLabel", {
                        Parent = DropdownItems["RealDropdown"].Instance,
                        Name = "\0",
                        ImageColor3 = FromRGB(170, 130, 255),
                        ScaleType = Enum.ScaleType.Fit,
                        BorderColor3 = FromRGB(0, 0, 0),
                        Size = UDim2New(0, 20, 0, 20),
                        AnchorPoint = Vector2New(1, 0.5),
                ...
                function Dropdown:AddOption(Option)
                    ...
                    function OptionData:Set()
                        if not Dropdown.Multi and OptionData.Selected then return end
                        OptionData.Selected = not OptionData.Selected
                ...
                function Dropdown:SetOpen(Bool)
                    ...
                    for Index, Value in Descendants do
                        ...
                        Value.ZIndex = Bool and 400 or (Value.ZIndex > 300 and Value.ZIndex - 50 or Value.ZIndex)
            ...
            function Colorpicker:SetOpen(Bool)
                ...
                if Bool then
                    ...
                    local _cpKey = Data.Flag or Data.Name or "Colorpicker"
                    Library.OpenFrames[_cpKey] = Colorpicker
                else
                    local _cpKey = Data.Flag or Data.Name or "Colorpicker"
                    if Library.OpenFrames[_cpKey] then
                        Library.OpenFrames[_cpKey] = nil
                    end
                end
            ...
            function Colorpicker:Update(IsFromAlpha)
                local Hue, Saturation, Value = Colorpicker.Hue, Colorpicker.Saturation, Colorpicker.Brightness
            ...
            function Colorpicker:Set(Color, Alpha)
                ...
                Colorpicker.Hue, Colorpicker.Saturation, Colorpicker.Brightness = Color:ToHSV()
                Colorpicker.Alpha = Alpha or 1

                local ColorPositionX = MathClamp(1 - Colorpicker.Saturation, 0, 0.98)
                local ColorPositionY = MathClamp(1 - Colorpicker.Brightness, 0, 0.97)
            ...
            Library:Connect(UserInputService.InputBegan, function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                    ...
                    if Library:IsMouseOverFrame(Items["ColorpickerWindow"]) or (AnimationsDropdownItems and AnimationsDropdownItems["OptionHolder"] and Library:IsMouseOverFrame(AnimationsDropdownItems["OptionHolder"])) then
                        return
                    end
        ...
        Components.Keybind = function(Data)
            ...
            local Items = { } do
                ...
                function Dropdown:Set(Option)
                    if Dropdown.Multi then
                        ...
                        local _resolvedOption = Option
                        if not Dropdown.Options[_resolvedOption] and Modes[_resolvedOption] then
                            _resolvedOption = Modes[_resolvedOption].Name
                        end

                        if not Dropdown.Options[_resolvedOption] then
                            return
                        end

                        local OptionData = Dropdown.Options[_resolvedOption]
            ...
            function Keybind:SetOpen(Bool)
                ...
                if Bool then
                    ...
                    local _kbKey = Data.Flag or Data.Name or "Keybind"
                    Library.OpenFrames[_kbKey] = Keybind
                else
                    ModesDropdown:SetOpen(false)

                    local _kbKey = Data.Flag or Data.Name or "Keybind"
                    if Library.OpenFrames[_kbKey] then
                        Library.OpenFrames[_kbKey] = nil
                    end
                end
                ...
                for Index, Value in Descendants do
                    ...
                    Value.ZIndex = Bool and (Value.ZIndex + 100) or (Value.ZIndex > 250 and Value.ZIndex - 100 or Value.ZIndex)
            ...
            function Keybind:Set(Key)
                if Key == "None" or (typeof(Key) == "EnumItem" and (Key.Name == "Escape" or Key.Name == "Backspace")) then
                    Keybind.Key = "None"
                    Keybind.Value = "None"
                ...
                elseif StringFind(tostring(Key), "Enum") then
                    ...
                    Key = (Key.Name == "Backspace" or Key.Name == "Escape") and "None" or Key.Name
                ...
                elseif type(Key) == "table" then
                    ...
                    local kStr = tostring(RealKey)
                    if kStr ~= "None" and not StringFind(kStr, "Enum") then
                        if StringFind(kStr, "Mouse") then
                            kStr = "Enum.UserInputType." .. kStr
                        else
                            kStr = "Enum.KeyCode." .. kStr
                        end
                    end
                    Keybind.Key = kStr

                    local _setMode = Key.Mode and StringLower(tostring(Key.Mode)) or "toggle"
                    Keybind.Mode = string.lower(_setMode)
                    Keybind:SetMode(_setMode)
            ...
            local _initMode = Data.Mode and StringLower(tostring(Data.Mode)) or "toggle"
            Keybind.Mode = _initMode
            ModesDropdown:Set(_initMode)
    ...
    do
        ...
        Library.ChatSystem = function(self, Data)
            ...
            local Items = { } do
                ...
                local _hasLogo = Window.Logo and Window.Logo ~= 0 and tostring(Window.Logo) ~= "0"
                if not _hasLogo then
                ...
                Items["Title"] = Instances:Create("TextLabel", {
                    ...
                    BackgroundTransparency = 1,
                    TextXAlignment = Enum.TextXAlignment.Left,
                    Position = _hasLogo and UDim2New(0, 37, 0.5, 0) or UDim2New(0, 10, 0.5, 0),
                    BorderSizePixel = 0,
                    AutomaticSize = Enum.AutomaticSize.X,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })  Items["Title"]:AddToTheme({TextColor3 = "Text"})
                ...
                Items["Messages"] = Instances:Create("ScrollingFrame", {
                    ...
                    ScrollBarImageColor3 = FromRGB(170, 130, 255),
        ...
        Library.Watermark = function(self, Text, Logo)
            local Watermark = { }
            Text = Text or (self.CurrentWindow and self.CurrentWindow.Name) or "kiwisense"
            Logo = Logo or (self.CurrentWindow and self.CurrentWindow.Logo) or "135215559087473"
            local _hasLogo = Logo and Logo ~= 0 and tostring(Logo) ~= "0" and tostring(Logo) ~= ""
            ...
            local Items = { } do
                ...
                Items["Logo"] = Instances:Create("ImageLabel", {
                    ...
                    ScaleType = Enum.ScaleType.Fit,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = _hasLogo and UDim2New(0, 22, 0, 22) or UDim2New(0, 0, 0, 0),
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = _hasLogo and ("rbxassetid://"..tostring(Logo)) or "",
                    Visible = _hasLogo,
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, 10, 0.5, 0),
                    ZIndex = 99999,
                ...
                Items["Text"] = Instances:Create("TextLabel", {
                    ...
                    Size = UDim2New(0, 0, 0, 15),
                    BackgroundTransparency = 1,
                    Position = _hasLogo and UDim2New(0, 35, 0.5, 0) or UDim2New(0, 10, 0.5, 0),
                    BorderSizePixel = 0,
                    AutomaticSize = Enum.AutomaticSize.X,
                    ZIndex = 99999,
                    TextSize = 14,
            ...
            self.WatermarkFrame = Items["Watermark"].Instance
        ...
        Library.KeybindsList = function(self)
            ...
            self.KeybindFrame = Items["KeybindsList"].Instance
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                Size = Data.Size or Data.size or (UserInputService.TouchEnabled and UDim2New(0, 659, 0, 340) or UDim2New(0, 659, 0, 511)),
            ...
            local Items = { } do
                ...
                local _hasLogo = Window.Logo and Window.Logo ~= 0 and tostring(Window.Logo) ~= "0" and Window.Logo ~= ""
                ...
                Items["Logo"] = Instances:Create("ImageLabel", {
                    ...
                    Size = _hasLogo and UDim2New(0, 22, 0, 22) or UDim2New(0, 0, 0, 0),
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = _hasLogo and ("rbxassetid://"..Window.Logo) or "",
                    BackgroundTransparency = 1,
                    Position = UDim2New(0, 10, 0.5, 0),
                    Visible = _hasLogo,
                    ZIndex = 2,
                ...
                Items["Title"] = Instances:Create("TextLabel", {
                    ...
                    BackgroundTransparency = 1,
                    TextXAlignment = Enum.TextXAlignment.Left,
                    Position = _hasLogo and UDim2New(0, 37, 0.5, 0) or UDim2New(0, 12, 0.5, 0),
                    BorderSizePixel = 0,
                    AutomaticSize = Enum.AutomaticSize.X,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })  Items["Title"]:AddToTheme({TextColor3 = "Text"})
                ...
                Items["Search"] = Instances:Create("Frame", {
                    ...
                    Name = "\0",
                    AnchorPoint = Vector2New(1, 0.5),
                    Size = UDim2New(0, 250, 0, 26),
                    Position = UDim2New(1, -48, 0.5, -2),
                    BorderColor3 = FromRGB(0, 0, 0),
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(22, 25, 29)
                ...
                if not UserInputService.TouchEnabled and Library.UseCustomCursor then
                    ...
                    Library:Connect(RunService.RenderStepped, function()
                        if Library.UseCustomCursor and Window.IsOpen and Items["MouseImage"] then
                            UserInputService.MouseIconEnabled = false
                            Items["MouseImage"].Instance.Visible = true
                            local MouseLocation = UserInputService:GetMouseLocation()
                            Items["MouseImage"].Instance.Position = UDim2New(0, MouseLocation.X, 0, MouseLocation.Y - 36)
                        else
                            UserInputService.MouseIconEnabled = true
                            if Items["MouseImage"] then
            ...
            function Window:SetOpen(Bool)
                ...
                if NewTween and NewTween.Tween then
                    ...
                    if Window.IsOpen then
                        if Library.UseCustomCursor then
            ...
            Library:Connect(UserInputService.InputBegan, function(Input, GameProcessedEvent)
                ...
                if not Library.Flags["MenuKeybind"] and not Library.Flags["UIKeybind"] then
            ...
            if Library.KeyList and Library.KeyList.Items and Library.KeyList.Items["KeybindsList"] then
                Library.KeybindFrame = Library.KeyList.Items["KeybindsList"].Instance
        ...
        Library.Page = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["Columns"] = Instances:Create("Frame", {
                    ...
                    BorderColor3 = FromRGB(0, 0, 0),
                    BackgroundTransparency = 1,
                    Position = Page.SubPages and UDim2New(0, 7, 0, 48) or UDim2New(0, 7, 0, 10),
                    Size = Page.SubPages and UDim2New(1, -14, 1, -55) or UDim2New(1, -14, 1, -15),
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                local _resolvedImage = ""
                local _hasIcon = false
                local _lucideData = nil
                if Page.Icon and Page.Icon ~= "" then
                    if tonumber(Page.Icon) then
                        _resolvedImage = "rbxassetid://" .. Page.Icon
                        _hasIcon = true
                    else
                        local lm = getgenv and getgenv().LucideModule
                        if lm then
                            _lucideData = lm.GetAsset(Page.Icon, 24)
                        end
                        if _lucideData then
                            _resolvedImage = _lucideData.Url
                            _hasIcon = true
                        end
                    end
                end
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    ImageTransparency = 0.5,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = _hasIcon and UDim2New(0, 22, 0, 22) or UDim2New(0, 0, 0, 0),
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = _resolvedImage,
                    ImageRectSize = _lucideData and _lucideData.ImageRectSize or Vector2.new(0, 0),
                    ImageRectOffset = _lucideData and _lucideData.ImageRectOffset or Vector2.new(0, 0),
                    BackgroundTransparency = 1,
                ...
                Items["Text"] = Instances:Create("TextLabel", {
                    ...
                    Text = Page.Name,
                    BackgroundTransparency = 1,
                    Position = _hasIcon and UDim2New(0, 32, 0.5, 0) or UDim2New(0, 7, 0.5, 0),
                    AutomaticSize = Enum.AutomaticSize.X,
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })  Items["Text"]:AddToTheme({TextColor3 = "Text"})
                ...
                Items["Inactive"].Instance.Size = Page._hasIcon and UDim2New(0, 25, 0, 32) or UDim2New(0, 10, 0, 32)
            end
            ...
            function Page:Switch(Bool)
                ...
                local _iconWidth = Page._hasIcon and 27 or 7
                local _collapsedWidth = Page._hasIcon and 25 or 10
                if Bool then
                    Items["Text"].Instance.Visible = true
                    Items["Inactive"]:Tween(nil, {BackgroundTransparency = 0, Size = UDim2New(0, Items["Text"].Instance.TextBounds.X + _iconWidth + 11, 0, 32)})
                    if Page._hasIcon then
                    ...
                    Items["Inactive"]:Tween(nil, {BackgroundTransparency = 1, Size = UDim2New(0, _collapsedWidth, 0, 32)})
                    if Page._hasIcon then
        ...
        Library.Pages.Playerlist = function(self, Data)
            ...
            local Items = { } do
                ...
                Instances:Create("UICorner", {
                    Parent = (Data.Parent or (Items["Playerlist"] and Items["Playerlist"].Instance)),
                    Name = "\0",
                    CornerRadius = UDimNew(0, 5)
                })
            ...
            do
                ...
                function Dropdown:SetOpen(Bool)
                    ...
                    for Index, Value in Descendants do
                        ...
                        Value.ZIndex = Bool and 50 or (Value.ZIndex > 40 and Value.ZIndex - 40 or Value.ZIndex)
        ...
        Library.Pages.AddSection = function(self, Name, Side)
            local data = type(Name) == "table" and Name or { Name = tostring(Name), Side = Side or 2 }
        ...
        Library.Sections.Input = function(self, Data)
            Data = Data or {}
            Data.Name = Data.Name or Data.Title or Data.Flag or "Input"
            return self:Textbox(Data)
        end

        Library.Sections.AddInput = function(self, Flag, Data)
            if type(Flag) == "table" then Data = Flag; Flag = nil end
            Data = Data or {}
            if Flag then Data.Flag = Flag end
            Data.Name = Data.Title or Data.Name or Data.Flag or "Input"
            return self:Textbox(Data)
        end

        Library.Sections.AddDropdown = function(self, Flag, Data)
            if type(Flag) == "table" then Data = Flag; Flag = nil end
            Data = Data or {}
            if Flag then Data.Flag = Flag end
            Data.Name = Data.Title or Data.Name or Data.Flag or "Dropdown"
            Data.Items = Data.Values or Data.Items or {}
            return self:Dropdown(Data)
        end

        Library.Sections.AddButton = function(self, Data)
            Data = Data or {}
            Data.Name = Data.Title or Data.Name or "Button"
            return self:Button(Data)
        end

        Library.Sections.AddToggle = function(self, Flag, Data)
            if type(Flag) == "table" then Data = Flag; Flag = nil end
            Data = Data or {}
            if Flag then Data.Flag = Flag end
            Data.Name = Data.Title or Data.Name or Data.Flag or "Toggle"
            return self:Toggle(Data)
        end

        Library.Sections.AddSlider = function(self, Flag, Data)
            if type(Flag) == "table" then Data = Flag; Flag = nil end
            Data = Data or {}
            if Flag then Data.Flag = Flag end
            Data.Name = Data.Title or Data.Name or Data.Flag or "Slider"
...
Library.Sections.Toggle = function(self, Data)
        ...
        Library.Sections.Slider = function(self, Data)
            local Slider = {
                ...
                Decimals = Data.Decimals or Data.decimals or Data.Step or Data.step or Data.Increment or Data.increment or Data.Rounding or Data.rounding or 1,
            ...
            local Items = { } do
                ...
                Items["Accent"] = Instances:Create("Frame", {
                    ...
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(170, 130, 255)
            ...
            function Slider:Set(Value)
                local step = Slider.Step or Slider.Increment or Slider.Rounding or Slider.Decimals or 1
                if type(step) == "number" and step > 0 then
                    local clamped = MathClamp(Value, Slider.Min, Slider.Max)
                    Slider.Value = math.floor((clamped / step) + 0.5) * step
                    if math.floor(step) ~= step then
                        local decStr = tostring(step):split(".")[2]
                        local decCount = decStr and #decStr or 1
                        Slider.Value = tonumber(string.format("%." .. decCount .. "f", Slider.Value)) or Slider.Value
                    else
                ...
                Items["Value"].Instance.Text = tostring(Slider.Value) .. tostring(Slider.Suffix or "")
            ...
            Items["RealSlider"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    local _absX = math.max(Items["RealSlider"].Instance.AbsoluteSize.X, 1)
                    local SizeX = math.clamp((Input.Position.X - Items["RealSlider"].Instance.AbsolutePosition.X) / _absX, 0, 1)
